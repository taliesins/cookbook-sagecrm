...
ca_cert = ssl_certificate node['sagecrm']['certificate']['CaCertificate']['common_name'] do
	...
	only_if { node['sagecrm']['instance']['FarmCertificateThumbprint'] == '' ||  node['sagecrm']['instance']['EncryptionCertificateThumbprint'] == '' }
end
